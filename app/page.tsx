...
export default function Home() {
  return (
    <div className="grid grid-cols-2 h-screen bg-home-desktop bg-cover bg-right bg-no-repeat">
      <NavBar />
      {/* <div className="col-span-2 border-4 border-indigo-500/75">Nav</div> */}
      {/* <div className="border-4 border-indigo-500/75">Left</div> */}
      {/* <div className="col-span-2border-4 border-indigo-500/75">Right</div> */}
      
      <main className="self-end">
      ...
      <aside className="justify-self-end self-end">
